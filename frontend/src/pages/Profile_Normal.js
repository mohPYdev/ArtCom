  ...
  return (
    <div className='main_profiless'>
        ...
        <form id="profile-form" onSubmit={submitting} method="get" style={{zIndex: 10}}>
            ...
            {/* <!--adding Bio textarea--> */}
            <textarea value={Bio_textarea_profiless} onChange={changeBioTextarea} id='Bio_textarea_profiless' name="Bio_textarea" cols="18" rows="20" placeholder="بیوگرافی" ></textarea>

            {/* <!--adding first name text--> */}
            <input value={firstname_text_profiless} onChange={changeFirstnameText} type="text" className='common_form_profiless' id='firstname_text_profiless' name="firstname_text" placeholder="نام" />
            {/* <!--adding last name text--> */}
            <input value={lastname_text_profiless} onChange={changeLastnameText} type="text" className='common_form_profiless' id='lastname_text_profiless' name="lastname_text" placeholder="نام خانوادگی" />
            {/* <!--adding last name text--> */}
            <input value={username_text_profiless} onChange={changeUsernameText} type="text" className='common_form_profiless' id='username_text_profiless' name="username_text" placeholder="نام کاربری" />
            {/* <!--adding email input--> */}
            <input value={email_input_profiless} onChange={changeEmailInput} type="email" className='common_form_profiless' id='email_input_profiless' name="email_input" placeholder="رایانامه" />
            {/* <!--adding phone number input--> */}
            <input value={phone_input_profiless} onChange={changePhoneInput} type="tel" className='common_form_profiless' id='phone_input_profiless' name="phone_input" placeholder="تلفن همراه" />
            {/* <!--adding address textarea--> */}
            <textarea value={Address_textarea_profiless} onChange={changeAddressTextarea} id='Address_textarea_profiless' name="Address_textarea" placeholder="آدرس" ></textarea>
            {/* <!--adding postal code input--> */}
            <input value={postalcode_input_profiless} onChange={changePostalcodeInput} type="tel" className='common_form_profiless' id='postalcode_input_profiless' name="postalcode_input" placeholder="کد پستی" />
