...
componentDidUpdate(){
    ...
    return (
       ...
       <div id="pizzaUp">
        ...
        <img src={EllipseUp} id="EllipseUp" onMouseEnter={() => this.setState( { isShownSignup : true }) }
        onMouseLeave={() => this.setState( { isShownSignup : false })} />
        <div id="sliceUp"> 
       
        <img src={EllipseUp1} id="EllipseUp1" /> 
        <Link  to="/signUpa" id="btn-signup-a" onMouseEnter={() => this.setState( { isShownSignup : true }) }
        onMouseLeave={() => this.setState( { isShownSignup : false })}>ثبت نام هنرمند</Link>
     
        <img src={EllipseUp2} id="EllipseUp2"/>  
        <Link  to="/signUpn"  id="btn-signup-n" onMouseEnter={() => this.setState( { isShownSignup : true }) }
        onMouseLeave={() => this.setState( { isShownSignup : false })} >
            ثبت نام کاربر عادی
        </Link>
        </div>
        ...
        <p id="pizzaDown--context">
           ...
           <img src={EllipseDown} id="EllipseDown" onMouseEnter={() => this.setState( { isShownLogin : true }) }
