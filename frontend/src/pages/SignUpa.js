...
return(
    ...
    <div id="sa_wrapper">
        <form method="get" onSubmit={handleSaSubmit}>
            ...
            <input value={sa_password} onChange={handlechangeSaPassword} type="password" id="sa_password" className="sa_box" name="password" placeholder="رمزعبور" /><br />
            <input value={sa_confirmpassword} onChange={handlechangeSaConfirmpassword} type="password" id="sa_confirmpassword" className="sa_box" name="confirmpassword" placeholder="تکرار رمزعبور" /><br />
